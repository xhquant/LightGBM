...
namespace LightGBM
{
    ...
    */
    ...
    public:
        ...
        */
        inline int MaxFeatureIdx() const override
        ...
        */
        inline std::vector<std::string> FeatureNames() const override
        ...
        */
        inline int LabelIdx() const override
        { return label_idx_; }
        ...
        */
        inline int NumberOfTotalModel() const override
        ...
        */
        inline int NumModelPerIteration() const override
        { return num_tree_per_iteration_; }

        /*!
        * \brief Get number of classes
        * \return Number of classes
        */
        inline int NumberOfClasses() const override
        { return num_class_; }
        ...
        */
        const char *SubModelName() const override
        { return "tree"; }

        bool IsLinear() const override
        { return linear_tree_; }

        inline std::string ParserConfigStr() const override
        { return parser_config_str_; }
